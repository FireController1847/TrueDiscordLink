package com.firecontroller1847.truediscordlink.database;
...
public class DbPlayer extends DatabaseObject {
    ...
    public DbPlayer(String name, String minecraft_uuid, String discord_id, boolean linked) {
        super(((TrueDiscordLink) TrueDiscordLink.getInstance()).getDatabaseManager().getDatabase().getType() == DatabaseType.SQLite ? TABLE_SCHEMA_SQLITE : TABLE_SCHEMA_MYSQL);
        this.id = id;
        this.name = name;
